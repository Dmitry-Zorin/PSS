...
import { ArrayField, ArrayInput, ChipField, Create, Datagrid, Edit, FileField, FileInput, Filter, List, minLength, NumberInput, required, SelectInput, Show, SimpleForm, SimpleFormIterator, SimpleShowLayout, SingleFieldList, TextField, TextInput } from 'react-admin'
...
export const ListForm = ({ permissions, ...props }) => (
	<List
		title='Список опытно-конструкторских работ'
		filters={<Filters/>}
		perPage={25}
		exporter={false}
...
export const CreateForm = props => (
	<Create
		title='Добавить опытно-конструкторскую работу'
		successMessage='Опытно-конструкторская работа добавлена'
		undoable={false}
		{...props}
	>
		<SimpleForm
