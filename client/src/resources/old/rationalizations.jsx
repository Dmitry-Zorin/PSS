...
const Filters = (props) => (
	<Filter {...props}>
		...
		<TextInput label="Автор" source="authors" />
		<ReferenceInput
			perPage={1000}
			label="Подразделение"
			source="subdivisions"
...
export const ListForm = ({ permissions, ...props }) => (
	...
	>
		<Datagrid rowClick="show" expand={<ShowForm enableActions={false} />}>
			...
			<ArrayField source="authors" label="Авторы">
...
export const CreateForm = (props) => (
	...
	>
		<SimpleForm redirect="list" submitOnEnter={false}>
			...
			<ArrayInput validate={validateRequired} source="authors" label="Авторы">
				<SimpleFormIterator>
			...
			<FileInput source="file" label="Архив" validate={validateRequired}>
...
export const EditForm = (props) => (
	...
	>
		<SimpleForm submitOnEnter={false}>
			...
			<NumberInput label="Год создания" source="creationDate" />
			<NumberInput label="Объем" source="volume" />
			<ArrayInput validate={validateRequired} label="Авторы" source="authors">
				<SimpleFormIterator>
					<TextInput label="Автор" source="author" />
				</SimpleFormIterator>
			</ArrayInput>
