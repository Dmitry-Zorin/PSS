			...
			<GridShowLayout>
				<RaGrid container spacing={2}>
					...
					<RaGrid item xs sx={styles.rightSide}>
						...
						<TextField label="Воинское звание" source="militaryRank" />
						<TextField label="Национальность" source="nationality" />
					</RaGrid>
				</RaGrid>
				...
				<RaGrid container spacing={2}>
					<RaGrid item xs={12} md={6}>
						...
						<TextField label="Образование" source="education" />
						<TextField label="Специальность" source="specialty" />
						<TextField label="Дата призыва" source="draftDate" />
						<TextField
					...
					<RaGrid item xs>
						<TextField label="Место рождения" source="birthPlace" />
						<TextField label="Окончил (когда, что)" source="university" />
						<TextField
