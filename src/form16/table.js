    ...
    return (
        new Table({
            ...
            rows: [
                ...
                ...getTableRows(data[1], author, index, 'б) авторские свидетельства, дипломы, патенты, лицензии, информационные карты, алгоритмы, проекты'),
                ...getTableRows(data[2], author, index, 'в) учебно-методические работы')
            ]
        })
    )
}
